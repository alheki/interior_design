...
#ifndef PHONENUMBERKIT_SWIFT_H
#define PHONENUMBERKIT_SWIFT_H
...
@class NSString;
@class NSCoder;
SWIFT_CLASS("_TtC14PhoneNumberKit20PhoneNumberFormatter")
...
@interface PhoneNumberFormatter (SWIFT_EXTENSION(PhoneNumberKit))
